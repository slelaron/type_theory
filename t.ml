...
print_string (string_of_list ((peano_of_int 1) :: (peano_of_int 2) :: (peano_of_int 3) :: []));;
print_string (string_of_list (rev ((peano_of_int 1) :: (peano_of_int 2) :: (peano_of_int 3) :: [])));;

print_string (string_of_list_int (merge_sort (1 :: 8 :: 7 :: 6 :: 5 :: 4 :: 3 :: 2 :: 1 :: [])));;
...
print_string ((list_of_strings_to_string (unique ("a" :: "b" :: "a" :: "c" :: "b" :: []))) ^ "\n");;
